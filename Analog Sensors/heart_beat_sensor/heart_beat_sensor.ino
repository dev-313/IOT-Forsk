...
void loop()
{
  ...
  Serial.print("Pulse raw value is = ");
...
void serialOutputWhenBeatHappens()     //  Decides How To OutPut BPM and IBI Data
{    
...
// Initialises Timer2 to throw an interrupt every 2mS.
void interruptSetup()                  
{     
